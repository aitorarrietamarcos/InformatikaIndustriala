...
int B_3 = CONTROLLINO_A5; //ESTO QUE ES?
int B_4 = CONTROLLINO_A6;
int S_1 = CONTROLLINO_A7;
int S_2 = CONTROLLINO_A8;
int S_3 = CONTROLLINO_A9;
int S_4 = CONTROLLINO_IN0;
int Em_Stop = CONTROLLINO_IN1;
